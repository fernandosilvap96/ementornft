        ...
        <div className={styles._intro_data}>
          ...
          <p>
           ...
           <h2 className={styles._title}>
            ...
            <p>
            33333 Unique Generative Crypto Fools from millions of possibilities.
            Why so many? Because we want to form a bigger community than ever.
          </p>
                     <h2 className={styles._title}>
            <span>Price: 0.03 ETH</span>
            </h2>
            <p>
            Mint price starts at 0.03 ETH and will increase by 0.01 ETH everyday until sold out.
            Maximum 10 Crypto Fools per mint. Reveal will be on April 14th.
          </p>
                     <h2 className={styles._title}>
            <span>Mint method: Stealth Mint and Public Mint Only!</span>
            </h2>
            <p>
            ...
            <p>
            CC0 means that creators waive those interests in their works and thereby place them as completely as possible in the public domain, so everyone may freely build upon, enhance and reuse the works for any purposes without restriction under copyright or.
            So basically you can do whatever you want with your Fools without worrying about copyrights.
          </p>
                     <h2 className={styles._title}>
            <span>Utility:</span>
            </h2>
